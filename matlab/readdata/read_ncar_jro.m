%
% data = read_ncar_jro([],[]);
% [data, mdata] = read_ncar_jro([],[]);
%
function [output, data] = read_ncar_jro(filename, verbose)
%
%     READ_NCAR_JRO Read JRO data in NCAR format
%
...
%
    ind_densvar = find(kodm_code == 500 | kodm_code == 510);    
